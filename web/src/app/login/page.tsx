        ...
        <div className="w-full max-w-sm">
          ...
          <div className="mb-10 text-center">
            <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl mb-5"
              style={{ background: 'var(--teal)', fontSize: '26px' }}>
              &#127807;
            </div>
            <h1 className="text-2xl font-semibold tracking-tight mb-1.5" style={{ color: 'var(--text)' }}>
              Welcome to Herb
            </h1>
            <p className="text-sm" style={{ color: 'var(--muted)' }}>AI-powered startup sourcing</p>
          </div>
          ...
          <div className="rounded-2xl p-6" style={{ background: 'var(--surface)', border: '1px solid var(--border)' }}>
            <button
              ...
              style={{ background: loading ? 'var(--border)' : '#0078d4', color: loading ? 'var(--muted)' : '#fff', cursor: loading ? 'not-allowed' : 'pointer' }}
            >
              {loading ? (
                <><div className="loading-spinner" /> Signing in&hellip;</>
              ) : (
                <>
          ...
          <div className="mt-5 rounded-xl p-4 text-xs leading-relaxed"
            style={{ background: 'var(--navy-light)', border: '1px solid #c8d8f0', color: 'var(--navy)' }}>
